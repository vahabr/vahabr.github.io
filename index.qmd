...
format:
  html:
    theme: cosmo        # <- forces Bootstrap 5
    css: styles.scss
---
...
> <div class="lead mt-3">
[**What Guides My Work**]{.underline}<br>
Numbers are easy.
[**Uncertainty**]{.mark} is the real challenge.
A model is never just numbers on a page.
It is a [**story**]{.mark} about uncertainty, a reflection of [**choices**]{.mark}, and a map of how we believe the [**world works**]{.mark}. 
The hardest part of risk is not predicting the future, but deciding what kind of [**future**]{.mark} we are willing to prepare for.<br>
...
📌 <span class="pill-link"><a href="posts/">Recent updates, notes, & news →</a></span>
...
::: {.column width="62%"}
![](img/profile.jpg){width="88%" fig-align="center"}
:::
:::
